...
var I18N = {
  fa: {
    ...
    chat_size_auto_hint: 'بر اساس موفقیت اخیر، خودش بهترین حالت را انتخاب می‌کند و امتیاز هرکدام را نشان می‌دهد.',
  ...
  en: {
    ...
    chat_size_auto: 'Auto',
    chat_size_auto_hint: 'Picks the best mode by recent success and shows each one\'s score.',
