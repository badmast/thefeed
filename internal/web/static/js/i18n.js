...
var I18N = {
  fa: {
    ...
    chat_err_unknown_recipient: 'این آدرس روی سرور یافت نشد',
    ...
    chat_enable_desc: 'یک حساب رمزنگاری‌شده روی این دستگاه ساخته می‌شود. آدرس شما فقط به سرورهایی فرستاده می‌شود که خودتان روشن کنید — تا قبل از آن چیزی منتشر نمی‌شود.',
    chat_enable_btn: 'فعال‌سازی پیام‌رسان',
    chat_servers_title: 'سرورهای گفتگو',
    chat_servers_hint: 'پیام‌رسان را فقط برای سرورهایی که به آن‌ها اعتماد دارید روشن کنید. آدرس شما فقط روی همین سرورها منتشر می‌شود.',
    chat_server_on: 'روشن',
  ...
  en: {
    ...
    chat_err_unknown_recipient: 'Address not found on this server',
    ...
    chat_enable_desc: 'This creates an encrypted account on this device. Your address is only ever published to servers you turn on — nothing leaves your device until then.',
    chat_enable_btn: 'Enable messenger',
    chat_servers_title: 'Chat servers',
    chat_servers_hint: 'Turn the messenger on only for servers you trust. Your address is published only to the servers you enable.',
    chat_server_on: 'On',
    chat_server_off: 'Off',
